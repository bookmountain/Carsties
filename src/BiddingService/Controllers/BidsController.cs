...
public class BidsController : ControllerBase
{
    ...
    {
        var auction = await DB.Find<Auction>().OneAsync(auctionId) ?? _grpcClient.GetAuction(auctionId);
        ...
        else
        {
            ...
            if (highBid != null && bid.Amount <= highBid.Amount) bid.BidStatus = BidStatus.TooLow;
        }
